...
proc op_and_unban {nick uhost handle chan text} {
	global botnick
	putserv "privmsg ChanServ :op $chan $botnick"
	utimer 1 [list putserv "mode $chan -bo [maskhost [lindex [split $text] 0]![getchanhost [lindex [split $text] 0] $chan] 2] $botnick " ]
}
...
proc op_and_unmute {nick uhost handle chan text} {
	global botnick
	putserv "privmsg ChanServ :op $chan $botnick"
	utimer 1 [list putserv "mode $chan -qo [maskhost [lindex [split $text] 0]![getchanhost [lindex [split $text] 0] $chan] 2] $botnick " ]
}